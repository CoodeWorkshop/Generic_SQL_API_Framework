...
final class FrontendUserRequestValidator
{
    ...
    private function createRole($role,array &$details):?string{if(!in_array($role,[RoleModel::READ_ONLY,RoleModel::DATA_OPERATOR,RoleModel::APPLICATION_ADMINISTRATOR,RoleModel::SYSTEM_ADMINISTRATOR],true))$details[]=['path'=>'role','message'=>'Invalid user role.'];return is_string($role)?$role:null;}
